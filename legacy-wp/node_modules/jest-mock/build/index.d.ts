...
import {FunctionParameters} from '@jest/expect-utils';
...
export declare class ModuleMocker {
  ...
  private _getSlots;
  private _resetWhenCalledWithSubMocks;
  private _makeWhenDispatcherImpl;
...
declare type OverloadedReturnType<T> = T extends {
