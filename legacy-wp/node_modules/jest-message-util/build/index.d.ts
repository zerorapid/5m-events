...
export declare function flattenErrorStack(error: Error): string;

export declare function formatErrorStack(
...
export declare function hasNestedErrors(value: unknown): value is Error;
