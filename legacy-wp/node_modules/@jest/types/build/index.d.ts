...
declare interface CacheKeyOptions extends ReducedTransformOptions {
...
declare interface CallerTransformOptions {
...
declare type DescribeRetryOptions = {
...
declare type TestError =
  Exception | [Exception | undefined, Exception | undefined];
