...
export declare type CallerTransformOptions =
  TransformTypes.CallerTransformOptions;
...
declare type ReducedTransformOptions = TransformTypes.ReducedTransformOptions;

declare interface RequireAndTranspileModuleOptions extends ReducedTransformOptions {
  applyInteropRequireDefault: boolean;
}
...
export declare interface ShouldInstrumentOptions extends Pick<
  Config.GlobalConfig,
