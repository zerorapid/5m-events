...
exports.makeEmptyAggregatedTestResult = exports.makeCollectedTestResult = exports.createEmptyTestResult = exports.buildFailureTestResult = exports.addResult = void 0;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
const makeCollectedTestResult = (testResults, {
  displayName,
  testFilePath
}) => {
  const count = status => testResults.filter(result => result.status === status).length;
  ...
  return {
    ...
    // as pending.
    numPendingTests: testResults.length - numFailingTests - numPassingTests - numTodoTests,
    numTodoTests,
    testFilePath,
    testResults
  };
};
exports.makeCollectedTestResult = makeCollectedTestResult;
...
Object.defineProperty(exports, "makeCollectedTestResult", ({
  enumerable: true,
  get: function () {
    return _helpers.makeCollectedTestResult;
  }
}));
