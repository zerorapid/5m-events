...
class NodeEnvironment {
  ...
  constructor(config, _context) {
    ...
    const globalsCleanupMode = (0, _jestUtil().initializeGarbageCollectionUtils)(globalThis, readGlobalsCleanupConfig(projectConfig));
    ...
    for (const [nodeGlobalsKey, descriptor] of nodeGlobals) {
      ...
      if ('value' in descriptor) {
        (0, _jestUtil().protectProperties)(descriptor.value);
      }
