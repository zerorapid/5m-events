...
var import_use_media_query = __toESM(require("../use-media-query/index.cjs"));
var useReducedMotion = () => (0, import_use_media_query.default)("(prefers-reduced-motion: reduce)");
