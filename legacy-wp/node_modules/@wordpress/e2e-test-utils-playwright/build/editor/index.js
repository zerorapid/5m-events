...
const owns_selection_1 = require("./owns-selection");
...
class Editor {
    ...
    getFocusOwnerLabel = owns_selection_1.getFocusOwnerLabel.bind(this);
    /** @borrows ownsSelection as this.ownsSelection */
    ownsSelection = owns_selection_1.ownsSelection.bind(this);
