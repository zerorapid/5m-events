 ...
 */
export type ElementSize = '5xs' | '4xs' | '3xs' | '2xs' | 'xs' | 'sm' | 'md' | 'lg';
/**
 ...
 */
export type SurfaceStrokeColor = 'neutral' | 'neutral-weak' | 'neutral-strong' | 'brand' | 'brand-strong' | 'success' | 'success-strong' | 'info' | 'info-strong' | 'warning' | 'warning-strong' | 'caution' | 'caution-strong' | 'error' | 'error-strong';
/**
 ...
 */
export type ForegroundColor = 'neutral' | 'neutral-weak' | 'success' | 'success-weak' | 'info' | 'info-weak' | 'warning' | 'warning-weak' | 'caution' | 'caution-weak' | 'error' | 'error-weak' | 'neutral-active' | 'neutral-disabled' | 'neutral-strong' | 'neutral-strong-active' | 'neutral-strong-disabled' | 'neutral-weak-active' | 'neutral-weak-disabled' | 'brand' | 'brand-active' | 'brand-disabled' | 'brand-strong' | 'brand-strong-active' | 'brand-strong-disabled' | 'error-active' | 'error-disabled' | 'error-strong' | 'error-strong-active' | 'error-strong-disabled';
/**
