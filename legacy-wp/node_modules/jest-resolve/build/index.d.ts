...
declare function isExplicitlyCommonjsPackage(modulePath: string): boolean;
...
declare type JSONValue =
  string | number | boolean | JSONObject | Array<JSONValue>;
 ...
 */
export declare function preloadResolver(
...
declare class Resolver {
  ...
  private readonly _isCoreModuleCache;
  private _canResolveSync;
  private _hasDistinctAsyncResolver;
  ...
  static unstable_isExplicitlyCommonjs: typeof isExplicitlyCommonjsPackage;
...
export declare interface ResolverOptions extends Omit<
  NapiResolveOptions,
  'extensions'
> {
